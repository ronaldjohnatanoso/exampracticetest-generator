...
if __name__ == '__main__':
    ...
    version = os.path.basename(base)   # "v2", "v3", etc.
    md_dir = os.path.dirname(base)       # az305/
    md_path = os.path.join(base, f"AZ-305-Cram-Guide-{version}.md")
    pdf_path = os.path.join(base, f"AZ-305-Cram-Guide-{version}.pdf")
